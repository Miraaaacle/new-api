...
const PersonalSetting = () => {
  ...
  const [notificationSettings, setNotificationSettings] = useState({
    ...
    adminUserQuotaNotifyThreshold: 0,
  ...
  useEffect(() => {
    if (userState?.user?.setting) {
      ...
      setNotificationSettings({
        ...
        adminUserQuotaNotifyThreshold:
          settings.admin_user_quota_notify_threshold || 0,
  ...
  const saveNotificationSettings = async () => {
    try {
      const res = await API.put('/api/user/setting', {
        ...
        admin_user_quota_notify_threshold:
          parseFloat(notificationSettings.adminUserQuotaNotifyThreshold) || 0,
